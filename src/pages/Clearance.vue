    ...
    <loading-container :is-loading="isLoading" v-slot="{ isLoading }">
      <section class="px-4 max-w-4xl mx-auto">
        <div
          ...
          class="border dark:border-primary-600 rounded-lg bg-gradient-to-b dark:from-primary-800 to-white dark:to-primary-800 text-center shadow px-8 md:px-0 py-12 flex flex-col items-center mb-8">
          ...
          <skeleton :delay="3 * 250" custom-class="h-5 md:h-6 w-full max-w-72">
            <h2 class="text-xl md:text-2xl text-zinc-600 dark:text-primary-200 mb-8">
              {{
                isCleared
        ...
        <div v-if="!isLoading && data!.items.length" class="bg-zinc-50 dark:bg-primary-800 shadow border dark:border-primary-600 rounded-lg">
          <div class="flex flex-col divide-y dark:divide-primary-600">
            <div
              ...
              class="flex justify-between cursor-pointer px-6 py-4 transition-colors hover:bg-zinc-100 dark:hover:bg-primary-700">
